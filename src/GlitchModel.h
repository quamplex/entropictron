...
class GlitchModel: public EntAbstractModel
{
 public:
        ...
        int repeats() const;
        void setRepeatsDefaultValue(int value);
        int getRepeatsDefaultValue() const;
        void setRepeatsRange(int from, int to);
        std::pair<int, int> getRepeatsRange() const;
 ...
 private:
        ...
        double dryDefaultValue;
        std::pair<double, double> dryRange;
        double wetDefaultValue;
        std::pair<double, double> wetRange;
};
